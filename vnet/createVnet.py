...
def resUnit2(bottom, kernelSize=3, numberOfOutput=16, stride=1, pad=1):
    ...
    relu1 = L.PReLU(bn1)
    conv1 = L.Convolution(relu1, convolution_param={"kernel_size": kernelSize, "stride": stride, "num_output": numberOfOutput, "pad": pad})

    bn2 = L.BatchNorm(conv1)
    relu2 = L.PReLU(bn2)
    conv2 = L.Convolution(relu2, convolution_param={"kernel_size": kernelSize, "stride": stride, "num_output": numberOfOutput, "pad": pad})
...
def resUnit3(bottom, kernelSize=3, numberOfOutput=16, stride=1, pad=1):
    ...
    relu3 = L.PReLU(bn3)
    conv3 = L.Convolution(relu3, convolution_param={"kernel_size": kernelSize, "stride": stride, "num_output": numberOfOutput, "pad": pad})
...
def vnet(phase, dataLayer, dataLayerParams):
    ...
    # net.conv_input = L.Convolution(net.data, convolution_param={"kernel_size": 1, "stride": 1, "num_output": 16, "pad": 0})
    ...
    net.left1_bn1, net.left1_relu1, net.left1_conv1, net.left1_bn2, net.left1_relu2, net.left1_conv2, net.left1_add = resUnit2(
        net.concat_input)
    net.pooling1 = L.Convolution(net.left1_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 32, "pad": 0})
    ...
    net.pooling2 = L.Convolution(net.left2_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 64, "pad": 0})
    ...
    net.pooling3 = L.Convolution(net.left3_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 128, "pad": 0})
    ...
    net.depooling1 = L.Deconvolution(net.vally_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 64, "pad": 0})
    ...
    net.depooling2 = L.Deconvolution(net.right1_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 32, "pad": 0})
    ...
    net.depooling3 = L.Deconvolution(net.right2_add, convolution_param={"kernel_size": 2, "stride": 2, "num_output": 16, "pad": 0})
    ...
    net.conv_output = L.Convolution(net.right3_add, convolution_param={"kernel_size": 1, "stride": 1, "num_output": 2, "pad": 0})
